...
| `HOME_DIRS`              | String  | Space-separated list of directories to be kept locally in HOME_LOCAL (e.g. `.cache`, `.local`, `Desktop`) <br>This parameter is only used while setting up the directory structure with `homesync -d`                                                                              |
| `HOME_FILES`             | String  | Space-separated list of directories to be kept locally in HOME_LOCAL (e.g. `.bashrc`, `.bash_history`, `.viminfo`) <br>This parameter is only used while setting up the directory structure with `homesync -d`                                                                     |
